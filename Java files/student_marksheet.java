...
// for averages and totals
        ...
        input.nextLine(); // consume leftover newline before nextLine()
...
//define the structure for the score sheet
        final String header_form = "| %-24s | %-25s | %-8s | %-8s | %-8s | %-8s | %-8s | %-8s | %-8s | %-8s | %-10s | %-8s | %-6s |\n";
        final String data_form = "| %-24s | %-25s | %-8d | %-8d | %-8d | %-8d | %-8d | %-8d | %-8d | %-8d | %-10.2f | %-8s | %-6s |\n";
